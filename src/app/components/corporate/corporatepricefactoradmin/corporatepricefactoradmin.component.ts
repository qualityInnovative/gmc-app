...
@Component({
  selector: 'ratelist-corporatepricefactoradmin',
  templateUrl: './corporatepricefactoradmin.component.html',
  styleUrls: ['./corporatepricefactoradmin.component.scss']
})
export class CorporatepricefactoradminComponent implements OnInit {
  User:User= new User();
  faEye = faEye;
  ...
  ngOnInit(): void {
    this.getallcorporatepricefactor()
    this.getCommodities();
    this.getUnits();
    this.getCorporation();
  }
  ...
  viewpricefactoradmin(id: number) {
    // corporate/corporatepricefactoradmin/viewpricefactor/:id
    this.router.navigate(['/corporate/corporatepricefactoradmin/viewpricefactoradmin/', id]);
  }
